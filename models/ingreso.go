...
type Ingreso struct {
	...
	EstadoActa                string                     `orm:"column(estado_acta);null"`
	...
	QuienElaboro              string                     `orm:"column(quien_elaboro);null"`
	QuienReviso               string                     `orm:"column(quien_reviso);null"`
	Concepto                  *Concepto                  `orm:"column(concepto);rel(fk)"`
	InformacionPersonaNatural *InformacionPersonaNatural `orm:"column(informacion_persona_natural);rel(fk)"`
